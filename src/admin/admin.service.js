...
export class AdminService {
  ...
  async dashboard() { const value = await this.admin.metrics(); return { users: { totalOwners: value.total_owners, activeOwners: value.active_owners }, restaurants: { total: value.total_restaurants, active: value.active_restaurants, published: value.published_restaurants }, content: { menuItems: value.total_menu_items, tables: value.total_tables } }; }

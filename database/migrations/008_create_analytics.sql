ALTER TABLE restaurant_tables ADD CONSTRAINT restaurant_tables_id_restaurant_key UNIQUE (id, restaurant_id);
ALTER TABLE menu_items ADD CONSTRAINT menu_items_id_category_restaurant_key UNIQUE (id, category_id, restaurant_id);
...
CREATE INDEX analytics_events_item_created_idx ON analytics_events (menu_item_id, created_at) WHERE menu_item_id IS NOT NULL;
CREATE INDEX analytics_events_category_created_idx ON analytics_events (category_id, created_at) WHERE category_id IS NOT NULL;
